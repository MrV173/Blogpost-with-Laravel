        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
              <div style="max-height: 350px; overflow:hidden">
                  ...
                  class="card-img-top img-fluid" alt="post">
              </div>
              @else
              <div style="max-height: 350px; overflow:hidden">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="position-absolute bg-dark px-3 py-2 text-white" style="background-color: rgba(0,0,0,0.9)">
                        <a href="/posts?category={{  $posts[0]->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a>
                    </div>
                        @if ($post->image)
                            <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid" alt="post">
                        @else
                            <img src="https://images.tokopedia.net/img/KRMmCm/2023/8/10/06246435-9d85-4849-a741-aa09daf7fa11.jpg" 
